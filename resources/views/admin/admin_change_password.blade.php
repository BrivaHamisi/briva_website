                            ...
                            <form method="POST" action="{{route('update.password')}}">
                                ...
                                <div class="col-12">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" name="oldpassword" id="oldpassword" type="text" id="example-text-input">
                                        </div>
                                    </div>
                                    <!-- end row -->
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" name="newpassword" id="newpassword"  type="text" id="example-search-input">
                                        </div>
                                    </div>
                                    <!-- end row -->
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" name="confirmpassword" id="confirmpassword" type="email" id="example-email-input">
                                        </div>
                                    </div>
                                    <!-- end row -->
