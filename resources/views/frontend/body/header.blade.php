            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="menu__wrap">
                        <nav class="menu__nav">
                            <div class="logo">
                                <a href="" class="logo__black"><img src="{{asset('logo/Briva_Digital_removebg_preview.png')}}" alt=""></a>
                                <a href="" class="logo__white"><img src="{{asset('logo/Briva_Digital_removebg_preview.png')}}" alt=""></a>
                            </div>
